...
app.post('/api/install/:bundle', (req, res) => {
    ...
    const installAppsSequentially = (index) => {
        if (index < selectedApps.length) {
            ...
            const installCommand = `echo 12345azerty | sudo -S yunohost app install baikal --args 'domain=dcm1tlg1.nohost.me&path=/baikal&init_main_permission=admins&password=12345azerty'`;
